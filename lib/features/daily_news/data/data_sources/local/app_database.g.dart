    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `bookmarked_article` (`author` TEXT, `title` TEXT, `description` TEXT, `content` TEXT, `url` TEXT, `urlToImage` TEXT, `publishedAt` TEXT, PRIMARY KEY (`title`))');
...
class _$ArticleDao extends ArticleDao {
  ...
  Future<List<ArticleModel>> getArticles() async {
    return _queryAdapter.queryList('SELECT * FROM bookmarked_article',
